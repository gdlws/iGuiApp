...
public class CLog
{
	...
	private static File folder = new File(Environment.getExternalStorageDirectory()//at 20150601"/sdcard/"
...
//at 20150601		DateFormat sdf = new SimpleDateFormat(FORMATSTR);
